...
const FixedLinkProps = useStore((state)=>state["Home"]["FixedLink"]);
const FixedLinkIoProps = useIoStore((state)=>state["Home"]["FixedLink"]);
const FixedLinkCb = useFixedLinkCb()
...
<Flex className="p-Home FixedLink bpt" {...FixedLinkProps} {...FixedLinkCb} {...FixedLinkIoProps}>
